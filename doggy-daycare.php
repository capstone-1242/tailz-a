...
<div class="tailz-doggy-daycare-content">
    ...
    <section>
        ...
        <p>Description(playroom, environment, outdoors)</p>
        <p>Requirements(documents, pest management, vaccinations)</p>
        ...
        <ul>
            ...
            <li>Saturdays: 10:00AM-5:00PM</li>
    ...
    <section>
        ...
        <p>Priority Overnight Booking, ‘Wag’ More Rewards, VIP Bonus!</p>
    ...
    <section>
        ...
        <p>
            Spay and Neuter: Pets over 7 months of age must be spayed and neutered. Our management team may grant exceptions with written medical reasons from your pet’s veterenarian for pets up to 10 months of age.
    ...
    <section>
        ...
        <p>Required Vaccinations (6+ months): Rabies, Distemper Combo & Bordetella. A complete set of vaccinations during your pups lifetime is still required prior to any exceptions granted.</p>
        ...
        <p>Pest Management: It is strongly recommended for your pet to be on monthly anti-parasite medication such as Revolution or Advantage, as this will greatly reduce the risk of spreading ticks, fleas, and lice to the facility and to your pup. Ask your veterinarian or purchase from over-the-counter.</p>
    </section>
