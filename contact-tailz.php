...
<div class="tailz-contact-content">
    ...
    <section class="hero-banner"
        style="background: linear-gradient(rgba(0, 0, 0, 0.52), rgba(0, 0, 0, 0.61)), url('<?php echo get_template_directory_uri(); ?>/images/hero/dogs-on-chair.webp') center/cover no-repeat; margin-top:20px;">
